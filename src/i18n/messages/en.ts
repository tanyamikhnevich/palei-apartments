export const en = {
  ...
  booking: {
    ...
    utilitiesNote:
      'Electricity and water are metered and settled on the spot — they are not part of the nightly rate.',
  ...
  flowers: {
    ...
    sub: 'Bouquets made up the morning they go out and balloon sets blown up fresh, brought to the door the next day — or left in the apartment before you arrive.',
    all: 'All',
    categories: {
      classic: 'Classic',
      seasonal: 'Seasonal',
    ...
    commentPlaceholder: 'Optional — allergies, a gate code, “no lilies”.',
    yourDetails: 'Your details',
    submit: 'Send order',
    cutoff: 'Orders go out the next day — the earliest delivery is tomorrow.',
    fromPrice: 'from {price}',
    builder: {
      title: 'Build your bouquet',
      count: 'How many roses',
      color: 'Colour',
      mixTitle: 'How many of each',
      mixLeft: '{n} more to place',
      mixOver: '{n} too many',
      mixDone: 'All {n} placed',
      tomorrow: 'tomorrow',
      onRequest: 'on request',
      onRequestNote: '{color} roses can often go out as soon as tomorrow, but we cannot promise it — we confirm availability with your order.',
      ownCount: 'Your own count',
      priceNote: 'This is the minimum price. The final one is confirmed with your order — a larger bouquet may need a bigger wrap or basket.',
      extras: 'Add to it',
      presentation: 'How it comes',
      today: 'today',
      inDays: '+{n} days',
      range: '{min}–{max} roses',
      leadNote: '{color} roses are brought in to order — the earliest delivery moves {n} days out.',
    },
  ...
  group: {
    ...
    services: {
      ...
      flowers: { label: 'Flowers and balloons', note: 'Delivered the next day' },
    },
  },
  validation: {
    nameRequired: 'Please enter your name.',
